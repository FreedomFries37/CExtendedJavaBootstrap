...
void* ll_Node_get_value_ptr1236203708(void* __this) {
    struct class_ll_Node1687898818* this = __this;
    struct class_std_Object250602564* super = __this;
    return (*this).value_ptr;
}

// void ll::Node::set_value_ptr (void*)
void ll_Node_set_value_ptr865800844(void* __this, void* val) {
    struct class_ll_Node1687898818* this = __this;
    struct class_std_Object250602564* super = __this;
    (*this).value_ptr = val;
}
...
void ll_IntLinkedList_add1241942693(void* __this, int element) {
    struct class_ll_IntLinkedList190643162* this = __this;
    struct class_std_Object250602564* super = __this;
    struct class_ll_Node1687898818* n = (*this).get_nth_node1776022683(this, ((*this).size-1));
    int* val = malloc(sizeof(int));
    (*val) = element;
    struct class_ll_Node1687898818* next = construct_ll_Node112386326_1435033459(class_ll_Node1687898818_init240947574(), val);
    (*n).next = next;
    (*next).prev = n;
    ++(*this).size;
}
...
struct class_ll_Node1687898818* ll_IntLinkedList_get_nth_node694164876(void* __this, int n) {
    struct class_ll_IntLinkedList190643162* this = __this;
    struct class_std_Object250602564* super = __this;
    struct class_ll_Node1687898818* ptr = (*this).head;
    for (int i = 0;(i<n); i++){
        ptr = (*ptr).next;
    }
...
int ll_IntLinkedList_get1241948506(void* __this, int index) {
    struct class_ll_IntLinkedList190643162* this = __this;
    struct class_std_Object250602564* super = __this;
    return (*(int*) ({
    	struct class_ll_Node1687898818* __temp = (*this).get_nth_node1776022683(this, index);
    	(*__temp).get_value_ptr138147117(__temp);
    }));
}

// int ll::IntLinkedList::size ()
int ll_IntLinkedList_size965940658(void* __this) {
    struct class_ll_IntLinkedList190643162* this = __this;
    struct class_std_Object250602564* super = __this;
    return (*this).size;
}
...
bool ll_IntLinkedList_remove_nth_element924601880(void* __this, int n) {
    struct class_ll_IntLinkedList190643162* this = __this;
    struct class_std_Object250602564* super = __this;
    ...
    struct class_ll_Node1687898818* prev = (*ptr).prev;
    struct class_ll_Node1687898818* next = (*ptr).next;
...
bool ll_IntLinkedList_remove307235464(void* __this, int value) {
    struct class_ll_IntLinkedList190643162* this = __this;
    struct class_std_Object250602564* super = __this;
    for (int i = 0;(i<(*this).size115917149(this)); ++i){
        struct class_ll_Node1687898818* n = (*this).get_nth_node1776022683(this, i);
