...
struct class_std_ClassInfo1868018659* construct_std_ClassInfo248086735_2038789188(void*, struct class_std_String1934042642*, struct class_std_ClassInfo1868018659*, int);
...
struct class_std_String1934042642* construct_std_String1748225611_395782108(void*, const char*);
...
struct class_ll_Node126923742* construct_ll_Node1918627717_1503862995(void*, void*);
...
struct class_ll_Node126923742* construct_ll_Node1918627717_1503862995(void* __this, void* value_ptr) {
...
void* ll_Node_get_value_ptr982527153(void* __this) {
    struct class_ll_Node126923742* this = __this;
    struct class_std_Object2065425124* super = __this;
    return (*this).value_ptr;
}

// void ll::Node::set_value_ptr (void*)
void ll_Node_set_value_ptr612124289(void* __this, void* val) {
    struct class_ll_Node126923742* this = __this;
    struct class_std_Object2065425124* super = __this;
    (*this).value_ptr = val;
}
...
void ll_IntLinkedList_add1495619248(void* __this, int element) {
    struct class_ll_IntLinkedList2005465722* this = __this;
    struct class_std_Object2065425124* super = __this;
    struct class_ll_Node126923742* n = (*this).get_nth_node1776022683(this, ((*this).size-1));
    int* val = malloc(sizeof(int));
    (*val) = element;
    struct class_ll_Node126923742* next = construct_ll_Node1918627717_1503862995(class_ll_Node126923742_init1331759313(), val);
    (*n).next = next;
    (*next).prev = n;
    ++(*this).size;
}

// CXClass ll::Node* ll::IntLinkedList::get_nth_node (int)
struct class_ll_Node126923742* ll_IntLinkedList_get_nth_node947841431(void* __this, int n) {
    struct class_ll_IntLinkedList2005465722* this = __this;
    struct class_std_Object2065425124* super = __this;
    struct class_ll_Node126923742* ptr = (*this).head;
    for (int i = 0;(i<n); i++){
        ptr = (*ptr).next;
    }
...
int ll_IntLinkedList_get1495625061(void* __this, int index) {
    struct class_ll_IntLinkedList2005465722* this = __this;
    struct class_std_Object2065425124* super = __this;
    return (*(int*) ({
    	struct class_ll_Node126923742* __temp = (*this).get_nth_node1776022683(this, index);
    	(*__temp).get_value_ptr138147117(__temp);
    }));
}

// int ll::IntLinkedList::size ()
int ll_IntLinkedList_size712264103(void* __this) {
    struct class_ll_IntLinkedList2005465722* this = __this;
    struct class_std_Object2065425124* super = __this;
    return (*this).size;
}
...
bool ll_IntLinkedList_remove_nth_element670925325(void* __this, int n) {
    struct class_ll_IntLinkedList2005465722* this = __this;
    struct class_std_Object2065425124* super = __this;
    ...
    struct class_ll_Node126923742* prev = (*ptr).prev;
    struct class_ll_Node126923742* next = (*ptr).next;
...
bool ll_IntLinkedList_remove560912019(void* __this, int value) {
    struct class_ll_IntLinkedList2005465722* this = __this;
    struct class_std_Object2065425124* super = __this;
    for (int i = 0;(i<(*this).size115917149(this)); ++i){
        struct class_ll_Node126923742* n = (*this).get_nth_node1776022683(this, i);
