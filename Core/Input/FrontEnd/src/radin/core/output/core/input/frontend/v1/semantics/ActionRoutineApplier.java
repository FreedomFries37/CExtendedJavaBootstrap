...
import radin.core.output.core.input.frontend.v1.MissingCategoryNodeError;
import radin.core.output.core.input.frontend.v1.parsing.CategoryNode;
import radin.core.output.core.input.frontend.v1.parsing.LeafNode;
                ...
                switch (node.getCategory()) {
                    case "TopLevelDeclaration": {
                        ...
                        if(node.hasChildCategory("CompilationTagList")) {
                            ...
                            if(synthesized instanceof TypeAbstractSyntaxNode) {
                                node.setSynthesized(
                                        new TypeAbstractSyntaxNode(synthesized, ((TypeAbstractSyntaxNode) synthesized).getCxType(), list)
                                );
                            }
                            else {
                                node.setSynthesized(
